      ...
      <Row className='w-100 page-1'>
        <Col md={6} className='left-part'>
          ...
          <Row className='role-check mb-5'>
            <Col md={3} xs={6} className='offset-0 offset-md-2 pr-0'>
              <Link>Tôi là giáo viên</Link>
            </Col>
            <Col md={4} xs={6} className='offset-0 offset-md-2 px-0'>
        ...
        <Col md={6} className='right-part px-0'>
          ...
          <Carousel dotPosition='right' autoplay={true} className='mt-1'>
            <div>
              <h3 className='floating-text'>
                Những học sinh tự nhủ "Mình có thể nhận được điểm cao hơn 10
                không nhỉ?"
              </h3>
            </div>
            <div>
              <h3 className='floating-text'>
                Những học sinh tự nhủ "Giờ mình càng chăm học, thì càng thoải
                mái tận hưởng kỳ nghỉ."
              </h3>
            </div>
            <div>
              <h3 className='floating-text'>
                Những học sinh tự nhủ "Đêm nay, mình sẽ làm xong bài tập để cuối
                tuần có thể đi chơi."
              </h3>
            </div>
          </Carousel>
