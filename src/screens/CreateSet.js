              ...
              <Row>
                <Col md={6}>
                  <TextField
                    ...
                    value={name}
                    onChange={(e) =>
                      this.handleChangeSet("name", e.target.value)
                    }
                  />
                </Col>
              </Row>
              <Row>
                <Col md={6}>
                  <TextField
                    ...
                    value={discription}
                    onChange={(e) =>
                      this.handleChangeSet("discription", e.target.value)
                    }
                  />
                </Col>
              </Row>
              ...
              <Row className="pt-3">
                <Col md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.handleChangeCard(index, "front_side", e.target.value)
                    }
                  />
                </Col>
                <Col md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      this.handleChangeCard(index, "back_side", e.target.value)
                    }
                  />
                </Col>
              </Row>
